      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link to="/agendamento">
              <Button size="lg" className="gradient-gold text-primary font-bold text-lg px-8 py-6 shadow-gold hover:opacity-90 transition-smooth">
                Agende Seu Serviço
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <Clock className="w-10 h-10 text-gold mb-4 mx-auto" />
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <Award className="w-10 h-10 text-gold mb-4 mx-auto" />
